...
var settings = {
	...
	xhr_ul_blob_megabytes: 30, //size in megabytes of the upload blobs sent in the upload test (forced to 4 on chrome mobile)
	//garbagePhp_chunkSize: 100, // size of chunks sent by garbage.php (can be different if enable_quirks is active)
	garbagePhp_chunkSize: 5, // size of chunks sent by garbage.php (can be different if enable_quirks is active)
